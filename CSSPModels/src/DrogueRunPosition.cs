...
namespace CSSPModels
{
    ...
    [NotMapped]
    public partial class DrogueRunPositionExtraA : DrogueRunPosition
    {
        #region Properties
        ...
        #region Constructors
        public DrogueRunPositionExtraA() : base()
        {
        }
        #endregion Constructors
    }
    [NotMapped]
    public partial class DrogueRunPositionExtraB : DrogueRunPositionExtraA
    {
        #region Properties
        [CSSPFill(FillTypeName = "TVItemLanguage", FillPlurial = "s", FillFieldID = "TVItemID", FillEqualField = "LastUpdateContactTVItemID", FillReturnField = "TVText", FillNeedLanguage = true, FillIsList = false)]
        [CSSPAllowNull]
        ...
        public string DrogueRunPositionReportTest { get; set; }
        #endregion Properties

        #region Constructors
        public DrogueRunPositionExtraB() : base()
        {
        }
        #endregion Constructors
    }
