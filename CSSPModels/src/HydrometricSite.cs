...
namespace CSSPModels
{
    ...
    {
        #region Properties
        [CSSPFill(FillTypeName = "TVItemLanguage", FillPlurial = "s", FillFieldID = "TVItemID", FillEqualField = "HydrometricSiteTVItemID", FillReturnField = "TVText", FillNeedLanguage = true, FillIsList = false)]
        ...
        public string HydrometricText { get; set; }
