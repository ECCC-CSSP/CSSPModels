...
namespace CSSPModels
{
    ...
    /// > <para>**Other properties** : [LastUpdateContactTVText](CSSPModels.ContactShortcut.html#CSSPModels_ContactShortcut_LastUpdateContactTVText), [HasErrors](CSSPModels.ContactShortcut.html#CSSPModels_ContactShortcut_HasErrors), [ValidationResults](CSSPModels.ContactShortcut.html#CSSPModels_ContactShortcut_ValidationResults), </para>
    /// > 
    ...
    public partial class ContactShortcut
    {
        ...
        /// <summary>
        /// > [!NOTE]
        /// > <para>Will be set to true if an error occurs during CRUD (Creating, Reading, Updating or Deleting) of [ContactShortcut](CSSPModels.ContactShortcut)</para>
        /// </summary>
        [NotMapped]
        public bool HasErrors { get; set; }
        /// <summary>
        /// > [!NOTE]
        /// > <para>Will hold all errors which were detected prior or during CRUD (Creating, Reading, Updating or Deleting) of [ContactShortcut](CSSPModels.ContactShortcut)</para>
        /// </summary>
        [NotMapped]
