...
namespace CSSPModels
{
    ...
    /// > <para>**Other properties** : [SubsectorTVText](CSSPModels.LabSheetDetail.html#CSSPModels_LabSheetDetail_SubsectorTVText), [LastUpdateContactTVText](CSSPModels.LabSheetDetail.html#CSSPModels_LabSheetDetail_LastUpdateContactTVText), [HasErrors](CSSPModels.LabSheetDetail.html#CSSPModels_LabSheetDetail_HasErrors), [ValidationResults](CSSPModels.LabSheetDetail.html#CSSPModels_LabSheetDetail_ValidationResults), </para>
    /// > 
    ...
    public partial class LabSheetDetail
    {
        ...
        /// <summary>
        /// > [!NOTE]
        /// > <para>Will be set to true if an error occurs during CRUD (Creating, Reading, Updating or Deleting) of [LabSheetDetail](CSSPModels.LabSheetDetail)</para>
        /// </summary>
        [NotMapped]
        public bool HasErrors { get; set; }
        /// <summary>
        /// > [!NOTE]
        /// > <para>Will hold all errors which were detected prior or during CRUD (Creating, Reading, Updating or Deleting) of [LabSheetDetail](CSSPModels.LabSheetDetail)</para>
        /// </summary>
        [NotMapped]
