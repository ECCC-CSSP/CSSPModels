...
namespace CSSPModels
{
    ...
    /// > <para>**Other properties** : [LastUpdateContactTVText](CSSPModels.BoxModelLanguage.html#CSSPModels_BoxModelLanguage_LastUpdateContactTVText), [LanguageText](CSSPModels.BoxModelLanguage.html#CSSPModels_BoxModelLanguage_LanguageText), [TranslationStatusText](CSSPModels.BoxModelLanguage.html#CSSPModels_BoxModelLanguage_TranslationStatusText), [HasErrors](CSSPModels.BoxModelLanguage.html#CSSPModels_BoxModelLanguage_HasErrors), [ValidationResults](CSSPModels.BoxModelLanguage.html#CSSPModels_BoxModelLanguage_ValidationResults), </para>
    /// > 
    ...
    public partial class BoxModelLanguage
    {
        ...
        /// <summary>
        /// > [!NOTE]
        /// > <para>Will be set to true if an error occurs during CRUD (Creating, Reading, Updating or Deleting) of [BoxModelLanguage](CSSPModels.BoxModelLanguage)</para>
        /// </summary>
        [NotMapped]
        public bool HasErrors { get; set; }
        /// <summary>
        /// > [!NOTE]
        /// > <para>Will hold all errors which were detected prior or during CRUD (Creating, Reading, Updating or Deleting) of [BoxModelLanguage](CSSPModels.BoxModelLanguage)</para>
        /// </summary>
        [NotMapped]
