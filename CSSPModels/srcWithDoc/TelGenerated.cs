...
namespace CSSPModels
{
    ...
    public partial class TelExtraA : Tel
    {
        ...
        /// > [!NOTE]
        /// > <para>**Other custom attributes**</para>
        /// > <para>[[CSSPFill](CSSPModels.CSSPFillAttribute.html)(FillTypeName = "TVItemLanguage", FillPlurial = "s", FillFieldID = "TVItemID", FillEqualField = "TelTVItemID", FillReturnField = "TVText", FillNeedLanguage = true, FillIsList = false)]</para>
        /// > <para>[[CSSPDisplayEN](CSSPModels.CSSPDisplayEN.html)(DisplayEN = "Tel number")]</para>
        /// > <para>[[CSSPDisplayFR](CSSPModels.CSSPDisplayFR.html)(DisplayFR = "Numéro de téléphone")]</para>
        /// > <para>[[CSSPDescriptionEN](CSSPModels.CSSPDescriptionEN.html)(DescriptionEN = "Tel number")]</para>
        /// > <para>[[CSSPDescriptionFR](CSSPModels.CSSPDescriptionFR.html)(DescriptionFR = "Numéro de téléphone")]</para>
        /// </summary>
        /// <returns>
        /// 
        /// **Display (en)** --- Tel number
        /// 
        /// **Display (fr)** --- Numéro de téléphone
        /// 
        /// **Description (en)** --- Tel number
        /// 
        /// **Description (fr)** --- Numéro de téléphone
        /// </returns>
