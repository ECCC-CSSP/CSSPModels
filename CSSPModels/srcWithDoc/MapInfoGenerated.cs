...
namespace CSSPModels
{
    ...
    public partial class MapInfoExtraA : MapInfo
    {
        ...
        /// > <para>[[CSSPDisplayEN](CSSPModels.CSSPDisplayEN.html)(DisplayEN = "Item text")]</para>
        /// > <para>[[CSSPDisplayFR](CSSPModels.CSSPDisplayFR.html)(DisplayFR = "Texte de l'élément")]</para>
        /// > <para>[[CSSPDescriptionEN](CSSPModels.CSSPDescriptionEN.html)(DescriptionEN = "Item text")]</para>
        /// > <para>[[CSSPDescriptionFR](CSSPModels.CSSPDescriptionFR.html)(DescriptionFR = "Texte de l'élément")]</para>
        /// </summary>
        /// <returns>
        /// 
        /// **Display (en)** --- Item text
        /// 
        /// **Display (fr)** --- Texte de l'élément
        /// 
        /// **Description (en)** --- Item text
        /// 
        /// **Description (fr)** --- Texte de l'élément
        /// </returns>
