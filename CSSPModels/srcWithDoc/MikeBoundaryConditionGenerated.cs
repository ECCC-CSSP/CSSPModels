...
namespace CSSPModels
{
    ...
    public partial class MikeBoundaryConditionExtraA : MikeBoundaryCondition
    {
        ...
        /// > [!NOTE]
        /// > <para>**Other custom attributes**</para>
        /// > <para>[[CSSPFill](CSSPModels.CSSPFillAttribute.html)(FillTypeName = "TVItemLanguage", FillPlurial = "s", FillFieldID = "TVItemID", FillEqualField = "MikeBoundaryConditionTVItemID", FillReturnField = "TVText", FillNeedLanguage = true, FillIsList = false)]</para>
        /// > <para>[[CSSPDisplayEN](CSSPModels.CSSPDisplayEN.html)(DisplayEN = "Mike boundary condition text")]</para>
        /// > <para>[[CSSPDisplayFR](CSSPModels.CSSPDisplayFR.html)(DisplayFR = "Mike boundary condition text (fr)")]</para>
        /// > <para>[[CSSPDescriptionEN](CSSPModels.CSSPDescriptionEN.html)(DescriptionEN = "Mike boundary condition text")]</para>
        /// > <para>[[CSSPDescriptionFR](CSSPModels.CSSPDescriptionFR.html)(DescriptionFR = "Mike boundary condition text (fr)")]</para>
        /// </summary>
        /// <returns>
        /// 
        /// **Display (en)** --- Mike boundary condition text
        /// 
        /// **Display (fr)** --- Mike boundary condition text (fr)
        /// 
        /// **Description (en)** --- Mike boundary condition text
        /// 
        /// **Description (fr)** --- Mike boundary condition text (fr)
        /// </returns>
