...
namespace CSSPModels
{
    ...
    public partial class UseOfSiteExtraA : UseOfSite
    {
        ...
        /// > [!NOTE]
        /// > <para>**Other custom attributes**</para>
        /// > <para>[[CSSPFill](CSSPModels.CSSPFillAttribute.html)(FillTypeName = "TVItemLanguage", FillPlurial = "s", FillFieldID = "TVItemID", FillEqualField = "SiteTVItemID", FillReturnField = "TVText", FillNeedLanguage = true, FillIsList = false)]</para>
        /// > <para>[[CSSPDisplayEN](CSSPModels.CSSPDisplayEN.html)(DisplayEN = "Site text")]</para>
        /// > <para>[[CSSPDisplayFR](CSSPModels.CSSPDisplayFR.html)(DisplayFR = "Texte du site")]</para>
        /// > <para>[[CSSPDescriptionEN](CSSPModels.CSSPDescriptionEN.html)(DescriptionEN = "Site text (climate, hydrometric or tide)")]</para>
        /// > <para>[[CSSPDescriptionFR](CSSPModels.CSSPDescriptionFR.html)(DescriptionFR = "Texte du site (climatique, hydrométrique ou de marée)")]</para>
        /// </summary>
        /// <returns>
        /// 
        /// **Display (en)** --- Site text
        /// 
        /// **Display (fr)** --- Texte du site
        /// 
        /// **Description (en)** --- Site text (climate, hydrometric or tide)
        /// 
        /// **Description (fr)** --- Texte du site (climatique, hydrométrique ou de marée)
        /// </returns>
