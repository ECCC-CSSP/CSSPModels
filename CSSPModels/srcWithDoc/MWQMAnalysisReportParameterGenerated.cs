...
namespace CSSPModels
{
    ...
    public partial class MWQMAnalysisReportParameterExtraA : MWQMAnalysisReportParameter
    {
        ...
        /// > [!NOTE]
        /// > <para>**Other custom attributes**</para>
        /// > <para>[[CSSPFill](CSSPModels.CSSPFillAttribute.html)(FillTypeName = "TVItemLanguage", FillPlurial = "s", FillFieldID = "TVItemID", FillEqualField = "ExcelTVFileTVItemID", FillReturnField = "", FillNeedLanguage = true, FillIsList = false)]</para>
        /// > <para>[[CSSPDisplayEN](CSSPModels.CSSPDisplayEN.html)(DisplayEN = "Excel TV file item TVItemLanguage")]</para>
        /// > <para>[[CSSPDisplayFR](CSSPModels.CSSPDisplayFR.html)(DisplayFR = "TVItemLanguage du document Excel TV file")]</para>
        /// > <para>[[CSSPDescriptionEN](CSSPModels.CSSPDescriptionEN.html)(DescriptionEN = "Excel TV file TVItemLanguage DB object")]</para>
        /// > <para>[[CSSPDescriptionFR](CSSPModels.CSSPDescriptionFR.html)(DescriptionFR = "Object BD TVItemLanguage document Excel TV file")]</para>
        /// > <para>[[CSSPAllowNull](CSSPModels.CSSPAllowNullAttribute.html)]</para>
        /// </summary>
        /// <returns>
        /// 
        /// **Display (en)** --- Excel TV file item TVItemLanguage
        /// 
        /// **Display (fr)** --- TVItemLanguage du document Excel TV file
        /// 
        /// **Description (en)** --- Excel TV file TVItemLanguage DB object
        /// 
        /// **Description (fr)** --- Object BD TVItemLanguage document Excel TV file
        /// </returns>
        ...
        /// > <para>[[CSSPDisplayEN](CSSPModels.CSSPDisplayEN.html)(DisplayEN = "Analysis report export command text")]</para>
        /// > <para>[[CSSPDisplayFR](CSSPModels.CSSPDisplayFR.html)(DisplayFR = "Texte de commande d'exportation du raport d'analyse")]</para>
        /// > <para>[[CSSPDescriptionEN](CSSPModels.CSSPDescriptionEN.html)(DescriptionEN = "Analysis report export command text")]</para>
        /// > <para>[[CSSPDescriptionFR](CSSPModels.CSSPDescriptionFR.html)(DescriptionFR = "Texte de commande d'exportation du raport d'analyse")]</para>
        /// > <para>[[CSSPAllowNull](CSSPModels.CSSPAllowNullAttribute.html)]</para>
        /// </summary>
        /// <returns>
        /// 
        /// **Display (en)** --- Analysis report export command text
        /// 
        /// **Display (fr)** --- Texte de commande d'exportation du raport d'analyse
        /// 
        /// **Description (en)** --- Analysis report export command text
        /// 
        /// **Description (fr)** --- Texte de commande d'exportation du raport d'analyse
        /// </returns>
