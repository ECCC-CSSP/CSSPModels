...
namespace CSSPModels.Tests
{
    ...
    public partial class MapInfoPointReportTest
    {
        ...
        {
            List<string> propNameList = new List<string>() { "MapInfoPointReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void MapInfoPointReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.MapInfoPointReportMapInfoPointReportTest);
        }
        [TestMethod]
