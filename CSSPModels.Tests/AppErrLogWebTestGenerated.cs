...
namespace CSSPModels.Tests
{
    ...
    public partial class AppErrLogWebTest
    {
        ...
        [TestMethod]
        public void AppErrLogWeb_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.AppErrLogWebLastUpdateContactTVText);
        }
        [TestMethod]
        public void AppErrLogWeb_Every_Property_Has_Get_Set_Test()
        {
               string val1 = "Some text";
               appErrLogWeb.LastUpdateContactTVText = val1;
               Assert.AreEqual(val1, appErrLogWeb.LastUpdateContactTVText);
        }
        #endregion Tests
    }
}
