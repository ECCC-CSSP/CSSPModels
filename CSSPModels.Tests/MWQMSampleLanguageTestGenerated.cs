...
namespace CSSPModels.Tests
{
    ...
    public partial class MWQMSampleLanguageTest
    {
        ...
        {
               Assert.IsNotNull(CSSPModelsRes.MWQMSampleLanguageMWQMSampleLanguageID);
               Assert.IsNotNull(CSSPModelsRes.MWQMSampleLanguageMWQMSampleID);
               Assert.IsNotNull(CSSPModelsRes.MWQMSampleLanguageLanguage);
               Assert.IsNotNull(CSSPModelsRes.MWQMSampleLanguageMWQMSampleNote);
