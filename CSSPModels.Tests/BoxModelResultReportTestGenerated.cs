...
namespace CSSPModels.Tests
{
    ...
    public partial class BoxModelResultReportTest
    {
        ...
        #region Constructors
        public BoxModelResultReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "BoxModelResultReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void BoxModelResultReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.BoxModelResultReportBoxModelResultReportTest);
        }
        [TestMethod]
