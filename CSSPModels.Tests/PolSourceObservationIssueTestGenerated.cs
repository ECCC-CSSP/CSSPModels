...
namespace CSSPModels.Tests
{
    public partial class PolSourceObservationIssueTest : SetupData
    {
        ...
        {
               Assert.IsNotNull(ModelsRes.PolSourceObservationIssuePolSourceObservationIssueID);
               Assert.IsNotNull(ModelsRes.PolSourceObservationIssuePolSourceObservationID);
               Assert.IsNotNull(ModelsRes.PolSourceObservationIssueObservationInfo);
               ...
               Assert.IsNotNull(ModelsRes.PolSourceObservationIssueHasErrors);
        }
        [TestMethod]
