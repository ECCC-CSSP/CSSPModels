...
namespace CSSPModels.Tests
{
    ...
    public partial class MapInfoReportTest
    {
        ...
        {
            List<string> propNameList = new List<string>() { "MapInfoReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void MapInfoReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.MapInfoReportMapInfoReportTest);
        }
        [TestMethod]
