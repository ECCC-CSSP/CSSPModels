...
namespace CSSPModels.Tests
{
    ...
    public partial class TVItemLanguageReportTest
    {
        ...
        #region Constructors
        public TVItemLanguageReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "TVItemLanguageReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void TVItemLanguageReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.TVItemLanguageReportTVItemLanguageReportTest);
        }
        [TestMethod]
