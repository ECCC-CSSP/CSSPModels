...
namespace CSSPModels.Tests
{
    ...
    public partial class MikeSourceStartEndWebTest
    {
        ...
        #region Constructors
        public MikeSourceStartEndWebTest()
        {
        ...
        [TestMethod]
        public void MikeSourceStartEndWeb_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.MikeSourceStartEndWebLastUpdateContactTVText);
        }
        [TestMethod]
        public void MikeSourceStartEndWeb_Every_Property_Has_Get_Set_Test()
        {
               string val1 = "Some text";
               mikeSourceStartEndWeb.LastUpdateContactTVText = val1;
               Assert.AreEqual(val1, mikeSourceStartEndWeb.LastUpdateContactTVText);
        }
        #endregion Tests
    }
}
