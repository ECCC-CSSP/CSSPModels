...
namespace CSSPModels.Tests
{
    ...
    public partial class BoxModelLanguageReportTest
    {
        ...
        #region Constructors
        public BoxModelLanguageReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "BoxModelLanguageReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void BoxModelLanguageReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.BoxModelLanguageReportBoxModelLanguageReportTest);
        }
        [TestMethod]
