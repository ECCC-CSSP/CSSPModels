...
namespace CSSPModels.Tests
{
    ...
    public partial class EmailDistributionListContactLanguageReportTest
    {
        ...
        #region Constructors
        public EmailDistributionListContactLanguageReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "EmailDistributionListContactLanguageReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void EmailDistributionListContactLanguageReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.EmailDistributionListContactLanguageReportEmailDistributionListContactLanguageReportTest);
        }
        [TestMethod]
