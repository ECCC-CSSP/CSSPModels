...
namespace CSSPModels.Tests
{
    ...
    public partial class LabSheetA1SheetTest
    {
        ...
        {
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetError);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetVersion);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSamplingPlanType);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSampleType);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetLabSheetType);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSubsectorName);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSubsectorLocation);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSubsectorTVItemID);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetRunYear);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetRunMonth);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetRunDay);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetRunNumber);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTides);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSampleCrewInitials);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationStartSameDay);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetWaterBathCount);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath1StartTime);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath2StartTime);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath3StartTime);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath1EndTime);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath2EndTime);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath3EndTime);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath1TimeCalculated);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath2TimeCalculated);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncubationBath3TimeCalculated);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetWaterBath1);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetWaterBath2);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetWaterBath3);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTCField1);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTCLab1);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTCHas2Coolers);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTCField2);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTCLab2);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTCFirst);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetTCAverage);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetControlLot);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetPositive35);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetNonTarget35);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetNegative35);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath1Positive44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath2Positive44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath3Positive44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath1NonTarget44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath2NonTarget44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath3NonTarget44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath1Negative44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath2Negative44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath3Negative44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBlank35);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath1Blank44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath2Blank44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetBath3Blank44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetLot35);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetLot44_5);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetRunComment);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetRunWeatherComment);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSampleBottleLotNumber);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSalinitiesReadBy);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSalinitiesReadYear);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSalinitiesReadMonth);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSalinitiesReadDay);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsReadBy);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsReadYear);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsReadMonth);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsReadDay);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsRecordedBy);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsRecordedYear);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsRecordedMonth);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetResultsRecordedDay);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetDailyDuplicateRLog);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetDailyDuplicatePrecisionCriteria);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetDailyDuplicateAcceptableOrUnacceptable);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIntertechDuplicateRLog);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIntertechDuplicatePrecisionCriteria);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIntertechDuplicateAcceptableOrUnacceptable);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIntertechReadAcceptableOrUnacceptable);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetApprovalYear);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetApprovalMonth);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetApprovalDay);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetApprovedBySupervisorInitials);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetIncludeLaboratoryQAQC);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetLog);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSamplingPlanTypeText);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetSampleTypeText);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetLabSheetTypeText);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetLabSheetA1MeasurementList);
               Assert.IsNotNull(CSSPModelsRes.LabSheetA1SheetHasErrors);
        }
        [TestMethod]
        public void LabSheetA1Sheet_Every_Property_Has_Get_Set_Test()
        {
               ...
               List<LabSheetA1Measurement> val174 = new List<LabSheetA1Measurement>();
               labSheetA1Sheet.LabSheetA1MeasurementList = val174;
               Assert.AreEqual(val174, labSheetA1Sheet.LabSheetA1MeasurementList);
               IEnumerable<ValidationResult> val264 = new List<ValidationResult>().AsEnumerable();
