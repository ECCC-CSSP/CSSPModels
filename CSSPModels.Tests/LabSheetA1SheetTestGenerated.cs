...
namespace CSSPModels.Tests
{
    ...
    public partial class LabSheetA1SheetTest
    {
        ...
        public void LabSheetA1Sheet_Every_Property_Has_Get_Set_Test()
        {
               ...
               labSheetA1Sheet.BackupDirectory = val82;
               Assert.AreEqual(val82, labSheetA1Sheet.BackupDirectory);
               string val83 = "Some text";
               labSheetA1Sheet.Log = val83;
               Assert.AreEqual(val83, labSheetA1Sheet.Log);
               string val84 = "Some text";
               labSheetA1Sheet.SamplingPlanTypeText = val84;
               Assert.AreEqual(val84, labSheetA1Sheet.SamplingPlanTypeText);
               string val85 = "Some text";
               labSheetA1Sheet.SampleTypeText = val85;
               Assert.AreEqual(val85, labSheetA1Sheet.SampleTypeText);
               string val86 = "Some text";
               labSheetA1Sheet.LabSheetTypeText = val86;
               Assert.AreEqual(val86, labSheetA1Sheet.LabSheetTypeText);
               List<LabSheetA1Measurement> val87 = new List<LabSheetA1Measurement>() { new LabSheetA1Measurement(), new LabSheetA1Measurement() };
               labSheetA1Sheet.LabSheetA1MeasurementList = val87;
               Assert.AreEqual(val87, labSheetA1Sheet.LabSheetA1MeasurementList);
               bool val88 = true;
               labSheetA1Sheet.HasErrors = val88;
               Assert.AreEqual(val88, labSheetA1Sheet.HasErrors);
               IEnumerable<ValidationResult> val267 = new List<ValidationResult>() { new ValidationResult("First Error Message") }.AsEnumerable();
               labSheetA1Sheet.ValidationResults = val267;
               Assert.AreEqual(val267, labSheetA1Sheet.ValidationResults);
        }
