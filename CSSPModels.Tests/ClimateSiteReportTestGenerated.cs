...
namespace CSSPModels.Tests
{
    ...
    public partial class ClimateSiteReportTest
    {
        ...
        {
            List<string> propNameList = new List<string>() { "ClimateSiteReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void ClimateSiteReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.ClimateSiteReportClimateSiteReportTest);
        }
        [TestMethod]
