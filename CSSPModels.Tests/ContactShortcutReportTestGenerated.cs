...
namespace CSSPModels.Tests
{
    ...
    public partial class ContactShortcutReportTest
    {
        ...
        #region Constructors
        public ContactShortcutReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "ContactShortcutReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void ContactShortcutReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.ContactShortcutReportContactShortcutReportTest);
        }
        [TestMethod]
