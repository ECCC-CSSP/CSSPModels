...
namespace CSSPModels.Tests
{
    ...
    public partial class SamplingPlanSubsectorReportTest
    {
        ...
        #region Constructors
        public SamplingPlanSubsectorReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "SamplingPlanSubsectorReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void SamplingPlanSubsectorReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.SamplingPlanSubsectorReportSamplingPlanSubsectorReportTest);
        }
        [TestMethod]
