...
namespace CSSPModels.Tests
{
    ...
    public partial class ContactPreferenceReportTest
    {
        ...
        #region Constructors
        public ContactPreferenceReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "ContactPreferenceReportText",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void ContactPreferenceReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.ContactPreferenceReportContactPreferenceReportText);
        }
        [TestMethod]
        public void ContactPreferenceReport_Every_Property_Has_Get_Set_Test()
        {
               string val1 = "Some text";
               contactPreferenceReport.ContactPreferenceReportText = val1;
               Assert.AreEqual(val1, contactPreferenceReport.ContactPreferenceReportText);
        }
        #endregion Tests
    }
}
