...
namespace CSSPModels.Tests
{
    ...
    public partial class MikeBoundaryConditionTest
    {
        ...
        {
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionMikeBoundaryConditionID);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionMikeBoundaryConditionTVItemID);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionMikeBoundaryConditionCode);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionMikeBoundaryConditionName);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionMikeBoundaryConditionLength_m);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionMikeBoundaryConditionFormat);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionMikeBoundaryConditionLevelOrVelocity);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionWebTideDataSet);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionNumberOfWebTideNodes);
               Assert.IsNotNull(CSSPModelsRes.MikeBoundaryConditionWebTideDataFromStartToEndDate);
