...
namespace CSSPModels.Tests
{
    ...
    public partial class AppTaskReportTest
    {
        ...
        {
            List<string> propNameList = new List<string>() { "AppTaskReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void AppTaskReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.AppTaskReportAppTaskReportTest);
        }
        [TestMethod]
