...
{
    [TestClass]
    public partial class RainExceedanceWebTest
    {
        #region Variables
        #endregion Variables
        ...
        [TestMethod]
        public void RainExceedanceWeb_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.RainExceedanceWebLastUpdateContactTVText);
        }
        [TestMethod]
        public void RainExceedanceWeb_Every_Property_Has_Get_Set_Test()
        {
               string val1 = "Some text";
               rainExceedanceWeb.LastUpdateContactTVText = val1;
               Assert.AreEqual(val1, rainExceedanceWeb.LastUpdateContactTVText);
        }
        #endregion Tests
    }
}
