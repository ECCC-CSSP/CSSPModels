...
{
    [TestClass]
    public partial class TideSiteReportTest
    {
        #region Variables
        #endregion Variables
        ...
        {
            List<string> propNameList = new List<string>() { "TideSiteReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void TideSiteReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.TideSiteReportTideSiteReportTest);
        }
        [TestMethod]
