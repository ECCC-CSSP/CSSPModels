...
namespace CSSPModels.Tests
{
    ...
    public partial class MWQMRunReportTest
    {
        ...
        {
            List<string> propNameList = new List<string>() { "MWQMRunReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void MWQMRunReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.MWQMRunReportMWQMRunReportTest);
        }
        [TestMethod]
