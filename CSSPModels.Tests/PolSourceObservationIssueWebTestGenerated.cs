...
namespace CSSPModels.Tests
{
    ...
    public partial class PolSourceObservationIssueWebTest
    {
        ...
        #region Constructors
        public PolSourceObservationIssueWebTest()
        {
        ...
        [TestMethod]
        public void PolSourceObservationIssueWeb_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.PolSourceObservationIssueWebLastUpdateContactTVText);
        }
        [TestMethod]
        public void PolSourceObservationIssueWeb_Every_Property_Has_Get_Set_Test()
        {
               string val1 = "Some text";
               polSourceObservationIssueWeb.LastUpdateContactTVText = val1;
               Assert.AreEqual(val1, polSourceObservationIssueWeb.LastUpdateContactTVText);
        }
        #endregion Tests
    }
}
