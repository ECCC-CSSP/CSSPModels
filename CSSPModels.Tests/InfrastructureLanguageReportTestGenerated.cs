...
namespace CSSPModels.Tests
{
    ...
    public partial class InfrastructureLanguageReportTest
    {
        ...
        #region Constructors
        public InfrastructureLanguageReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "InfrastructureLanguageReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void InfrastructureLanguageReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.InfrastructureLanguageReportInfrastructureLanguageReportTest);
        }
        [TestMethod]
