...
{
    [TestClass]
    public partial class ResetPasswordReportTest
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public ResetPasswordReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "ResetPasswordReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void ResetPasswordReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.ResetPasswordReportResetPasswordReportTest);
        }
        [TestMethod]
