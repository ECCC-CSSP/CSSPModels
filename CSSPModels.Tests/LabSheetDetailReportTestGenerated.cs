...
namespace CSSPModels.Tests
{
    ...
    public partial class LabSheetDetailReportTest
    {
        ...
        #region Constructors
        public LabSheetDetailReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "LabSheetDetailReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void LabSheetDetailReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.LabSheetDetailReportLabSheetDetailReportTest);
        }
        [TestMethod]
