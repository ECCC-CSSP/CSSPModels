...
namespace CSSPModels.Tests
{
    public partial class ContactShortcutTest
    {
        ...
        {
               Assert.IsNotNull(ModelsRes.ContactShortcutContactShortcutID);
               Assert.IsNotNull(ModelsRes.ContactShortcutContactID);
               Assert.IsNotNull(ModelsRes.ContactShortcutShortCutText);
