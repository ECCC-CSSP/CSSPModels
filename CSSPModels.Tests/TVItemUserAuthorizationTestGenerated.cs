...
namespace CSSPModels.Tests
{
    ...
    public partial class TVItemUserAuthorizationTest
    {
        ...
        public void TVItemUserAuthorization_Every_Property_Has_A_Resource_OK()
        {
               ...
               Assert.IsNotNull(CSSPModelsRes.TVItemUserAuthorizationContactTVText);
               Assert.IsNotNull(CSSPModelsRes.TVItemUserAuthorizationTVText1);
               Assert.IsNotNull(CSSPModelsRes.TVItemUserAuthorizationTVText2);
               Assert.IsNotNull(CSSPModelsRes.TVItemUserAuthorizationTVText3);
               Assert.IsNotNull(CSSPModelsRes.TVItemUserAuthorizationTVText4);
               Assert.IsNotNull(CSSPModelsRes.TVItemUserAuthorizationLastUpdateContactTVText);
               Assert.IsNotNull(CSSPModelsRes.TVItemUserAuthorizationTVAuthText);
