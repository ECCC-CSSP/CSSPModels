...
namespace CSSPModels.Tests
{
    ...
    public partial class MWQMSiteStartEndDateReportTest
    {
        ...
        #region Constructors
        public MWQMSiteStartEndDateReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "MWQMSiteStartEndDateReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void MWQMSiteStartEndDateReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.MWQMSiteStartEndDateReportMWQMSiteStartEndDateReportTest);
        }
        [TestMethod]
