...
namespace CSSPModels.Tests
{
    ...
    public partial class ContactPreferenceTest
    {
        ...
        {
               Assert.IsNotNull(CSSPModelsRes.ContactPreferenceContactPreferenceID);
               Assert.IsNotNull(CSSPModelsRes.ContactPreferenceContactID);
               Assert.IsNotNull(CSSPModelsRes.ContactPreferenceTVType);
