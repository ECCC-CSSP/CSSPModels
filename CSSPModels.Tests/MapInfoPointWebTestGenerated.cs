...
namespace CSSPModels.Tests
{
    ...
    public partial class MapInfoPointWebTest
    {
        ...
        [TestMethod]
        public void MapInfoPointWeb_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.MapInfoPointWebLastUpdateContactTVText);
        }
        [TestMethod]
        public void MapInfoPointWeb_Every_Property_Has_Get_Set_Test()
        {
               string val1 = "Some text";
               mapInfoPointWeb.LastUpdateContactTVText = val1;
               Assert.AreEqual(val1, mapInfoPointWeb.LastUpdateContactTVText);
        }
        #endregion Tests
    }
}
