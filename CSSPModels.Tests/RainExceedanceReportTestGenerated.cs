...
{
    [TestClass]
    public partial class RainExceedanceReportTest
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public RainExceedanceReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "RainExceedanceReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void RainExceedanceReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.RainExceedanceReportRainExceedanceReportTest);
        }
        [TestMethod]
