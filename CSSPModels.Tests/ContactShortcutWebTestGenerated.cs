...
namespace CSSPModels.Tests
{
    ...
    public partial class ContactShortcutWebTest
    {
        ...
        [TestMethod]
        public void ContactShortcutWeb_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.ContactShortcutWebLastUpdateContactTVText);
        }
        [TestMethod]
        public void ContactShortcutWeb_Every_Property_Has_Get_Set_Test()
        {
               string val1 = "Some text";
               contactShortcutWeb.LastUpdateContactTVText = val1;
               Assert.AreEqual(val1, contactShortcutWeb.LastUpdateContactTVText);
        }
        #endregion Tests
    }
}
