...
namespace CSSPModels.Tests
{
    ...
    public partial class MWQMSubsectorTest
    {
        ...
        {
               Assert.IsNotNull(CSSPModelsRes.MWQMSubsectorMWQMSubsectorID);
               Assert.IsNotNull(CSSPModelsRes.MWQMSubsectorMWQMSubsectorTVItemID);
               Assert.IsNotNull(CSSPModelsRes.MWQMSubsectorSubsectorHistoricKey);
