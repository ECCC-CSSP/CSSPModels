...
namespace CSSPModels.Tests
{
    ...
    public partial class SpillLanguageReportTest
    {
        ...
        #region Constructors
        public SpillLanguageReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "SpillLanguageReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void SpillLanguageReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.SpillLanguageReportSpillLanguageReportTest);
        }
        [TestMethod]
