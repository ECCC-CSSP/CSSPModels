...
{
    [TestClass]
    public partial class MWQMSampleLanguageReportTest
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public MWQMSampleLanguageReportTest()
        {
        ...
        {
            List<string> propNameList = new List<string>() { "MWQMSampleLanguageReportTest",  }.OrderBy(c => c).ToList();
        ...
        [TestMethod]
        public void MWQMSampleLanguageReport_Every_Property_Has_A_Resource_OK()
        {
               Assert.IsNotNull(CSSPModelsRes.MWQMSampleLanguageReportMWQMSampleLanguageReportTest);
        }
        [TestMethod]
